...
(function() {
  var address, app, bodyParser, card, city, classify, config, cookieParser, coupon, customer, district, domain, ent, express, favicon, feedback, index, invoice, log4js, logger, marketing, member, mongoose, news, order, path, payLog, price, product, province, report, server, uri;
